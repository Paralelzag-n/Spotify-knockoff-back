...
//     const giorgi_g = new UserEntity();
//     giorgi_g.id = '9dcf713b-1ff2-47d8-8ba1-13f8ab8dcec8';
//     giorgi_g.email = 'giorgi.gvishiani@lavapi.com';
//     giorgi_g.first_name = 'Giorgi';
//     giorgi_g.last_name = 'Gvishiani';
//     giorgi_g.created_at = Date.now();
//     giorgi_g.updated_at = Date.now();
//
...
//
//     const users = [giorgi_g, zviad, beka, luka, aleksandre, giorgi_k, teona];
//
//     await Promise.all(
